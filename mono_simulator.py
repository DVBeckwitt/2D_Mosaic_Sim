...
def build_mono_figure(theta_min: float = math.radians(THETA_DEFAULT_MIN),
    ...
    fig.update_layout(scene=dict(xaxis=dict(title=dict(text=r"$G_x\\,(\\mathrm{\\AA}^{-1})$"),
                                            range=[-axis_range, axis_range],
                                            autorange=False,
                                            showbackground=False,
                                            showticklabels=False,
                                            zeroline=False),
                                 yaxis=dict(title=dict(text=r"$G_y\\,(\\mathrm{\\AA}^{-1})$"),
                                            range=[-axis_range, axis_range],
                                            autorange=False,
                                            showbackground=False,
                                            showticklabels=False,
                                            zeroline=False),
                                 zaxis=dict(title=dict(text=r"$G_z\\,(\\mathrm{\\AA}^{-1})$"),
                                            range=[-axis_range, axis_range],
                                            autorange=False,
                                            showbackground=False,
                                            showticklabels=False,
