...
- Shipping status: local `pip check`, compile, full test suite, package build, code review, and diff whitespace checks pass for the matrix export merge. The 2026-05-21 cleanup also passed focused special-cause matrix tests, full pytest, compile, `pip check`, and `git diff --check`; rollback is a normal git revert of the matrix export feature or cleanup commit. See `docs/launch/2026-05-13-special-cause-matrix-export.md`.
